...
|---|---|---|---|---|---|---|
| SRCF-001 (Indian Standards Specifications) | 1 | 1 | 1 | 0 | 4 | 0 |
| SRCF-004 (BIS Product Manuals) | 639 | 639 | 637 | 2 | 17064 | 0 |
| SRCF-008 (BIS Testing Laboratories Registers) | 4 | 4 | 0 | 4 | 0 | 0 |
| SRCF-011 (BIS Informative FAQs, Guides & Booklets) | 2 | 2 | 2 | 0 | 99 | 0 |
...
|---|---|---|---|
| SRC-013-28-7131116-HITECHLAB-HEALTHCARE-RESEARCH | CONSUMER_GUIDE | SRCF-008 (BIS Testing Laboratories Registers) | Extraction failed: Expecting value: line 2 column 1 (char 1) |
| SRC-013-43-8127706-BUREAU-VERITAS-CONSUMER-PRODU | CONSUMER_GUIDE | SRCF-008 (BIS Testing Laboratories Registers) | Extraction failed: Expecting value: line 2 column 1 (char 1) |
| SRC-013-423-8198324-EMC-EMI-TESTING-LAB-HLL-LIFE | CONSUMER_GUIDE | SRCF-008 (BIS Testing Laboratories Registers) | Extraction failed: Expecting value: line 2 column 1 (char 1) |
| SRC-013-99-7120616-ENVIROCARE-LABS-PVT-LTD-THANE | CONSUMER_GUIDE | SRCF-008 (BIS Testing Laboratories Registers) | Extraction failed: Expecting value: line 2 column 1 (char 1) |
| PM-SRC-006-230-IS-9020-2002-POWER-THRESHERS-SAFETY- | PRODUCT_MANUAL | SRCF-004 (BIS Product Manuals) | EXTRACTION_FAILED: Empty or scanned PDF with no extractable text layer |
| PM-SRC-006-IS-14806-2021-AZOSPIRILLUM-INOCULANTS | PRODUCT_MANUAL | SRCF-004 (BIS Product Manuals) | EXTRACTION_FAILED: Empty or scanned PDF with no extractable text layer |
